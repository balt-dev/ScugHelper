...
return {
    name = "ScugHelper/SandboxedLuaConditionAction",
    depth = -100,
    placements = {
        {
            name = "normal",
    ...
    ignoredFields = function(entity)
        ...
        if entity.__eula or scughelper.eulaAccepted then
            ...
            return {"_name", "_id", "originX", "originY", "Arguments", "FilePath", "InlineLua", "x", "y", "width", "height", "Immediate", "Groups", "Delay"}
        end
    end,
    fieldInformation = {
        Arguments = {
