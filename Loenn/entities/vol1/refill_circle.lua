...
return {
    ...
    ignoredFields = {"_name", "_id", "originX", "originY", "Radius"},
    sprite = function(room, entity)
        entity.Radius = math.min(entity.width / 2, entity.height / 2)
        ...
        return drawableFunc.fromFunction(function()
            drawing.callKeepOriginalColor(function()
                love.graphics.setColor(infillColor)
                love.graphics.circle("fill", entity.x + entity.Radius, entity.y + entity.Radius, entity.Radius - 2);
